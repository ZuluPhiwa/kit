...
const Products = (props) => {
  ...
  return (
    ...
    <img
        ...
        alt="image"
    />
    <div className="p-4 bg-gray-300 rounded-b-lg font-bebasneuebold tracking-widest">
        <h4 className="text-xl font-semibold tracking-tight text-blue-600">
            {productName}
        </h4>
        <p className="mb-2 leading-normal font-bebasneuebold tracking-wider text-lg">
            E{price}
        </p>
